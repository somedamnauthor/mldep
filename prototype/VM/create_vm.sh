...
virt-install $qemu_args --name=mldep_vm${1} --ram=2048 $vcpu_arg --import --disk path=$qemu_dir/mldepimg${1}.img,format=qcow2 --disk path=$qemu_dir/cidata${1}.iso,device=cdrom --network bridge=virbr0,model=virtio --graphics none --noautoconsole
